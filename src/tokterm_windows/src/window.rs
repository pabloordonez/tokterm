...
impl WindowsWindow {
    ...
    pub fn get_window_size(&self) -> Result<Size2d> {
    ...
    pub fn get_window_client_size(&self) -> Result<Size2d> {
        let mut rect = RECT::empty();
    ...
    pub fn set_window_size(&self, size: Size2d) -> Result<()> {
        let mut rect = RECT::empty();
        let success = unsafe { GetWindowRect(self.window_handle, &mut rect) };
    ...
    pub fn get_window_position(&self) -> Result<Point2d> {
        let mut rect = RECT::empty();
        let success = unsafe { GetWindowRect(self.window_handle, &mut rect) };
    ...
    pub fn set_window_position(&self, position: Point2d) -> Result<()> {
        let mut rect = RECT::empty();
        let success = unsafe { GetWindowRect(self.window_handle, &mut rect) };
